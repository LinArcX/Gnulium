...
Item {
    ...
    Popup {
        ...
        Rectangle{
            ...
            Text {
                text: qsTr(Str.repoSummaryPopUp)
                font.pixelSize: 14
    ...
    Rectangle{
        ...
        Image{
            ...
            MouseArea {
                ...
                onClicked: {
                    ...
                    mPacman.execRepoSummary();
                    console.log(Str.pacmanSummary);
                }
            }
        }
        ...
        LinArcxTextField {
            ...
            anchors.margins: 5
            placeholderText: qsTr(Str.pacmanSummary)
        }
