...
import linarcx.gnulium.Services 1.0
...
Column {
    ...
    LinArcxPopUp {
        ...
        mTitle: qsTr(Str.activeServiceTitle)
        mBody: qsTr(Str.activeServicePopUp)
    }
    ...
    Rectangle {
        ...
        LinArcxTextField {
            ...
            anchors.margins: 5
            placeholderText: qsTr(Str.activeServiceTitle)
        }
        ...
        TableTwoColumn {
            ...
            firstTitle: qsTr(Str.lasFirst)
            secondTitle: qsTr(Str.lasSecond)
